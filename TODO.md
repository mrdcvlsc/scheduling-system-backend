...
1. File: [./GeneticAlgorithm/GenerateIndividual.go](./GeneticAlgorithm/GenerateIndividual.go), Line: 212
...
2. File: [./GeneticAlgorithm/GenerateIndividual.go](./GeneticAlgorithm/GenerateIndividual.go), Line: 224

    the map below was added for debugging purposes only, remove when the code becomes stable and optimized.

3. File: [./GeneticAlgorithm/GenerateIndividual.go](./GeneticAlgorithm/GenerateIndividual.go), Line: 433

    [implement below] search for general rooms that are available (consult first)

4. File: [./GeneticAlgorithm/GenerateIndividual.go](./GeneticAlgorithm/GenerateIndividual.go), Line: 435

    [implement below] search available lab room for lecture subjects (consult first)

5. File: [./GeneticAlgorithm/GenerateIndividual.go](./GeneticAlgorithm/GenerateIndividual.go), Line: 584
...
6. File: [./Routes/RoutesV1/GetClassSchedule.go](./Routes/RoutesV1/GetClassSchedule.go), Line: 39

    use department_id for authentication later on.

7. File: [./Routes/RoutesV1/GetClassSchedule.go](./Routes/RoutesV1/GetClassSchedule.go), Line: 176

    use department_id for authentication later on.

8. File: [./Routes/RoutesV1/GenerateSchedule.go](./Routes/RoutesV1/GenerateSchedule.go), Line: 35
