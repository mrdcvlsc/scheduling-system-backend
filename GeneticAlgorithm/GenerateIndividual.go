		...
		func(indicies IterIndices, values IterValues) IterReturnType {
			...
			for _, subject := range semester.Subjects {
				...
				for class_type_iter := 0; class_type_iter < 2; class_type_iter++ {
					...
					is_subject_assignment_successful := false

					// department specific room and time slot iteration

				loop_with_department_room_assignment:
					for i := range total_iterations {
						...
						if !is_time_slot_available && i == total_iterations-1 {
							...
							break loop_with_department_room_assignment // return IterBreakCurriculumLoop
						}
						...
						is_subject_assignment_successful = true

						break
					} // -------------- end of week time slot iteration loop (department specific rooms) --------------

					// #####################################################################################################################

					if is_subject_assignment_successful {
						continue
					}

					// general specific room and time slot iteration

				loop_with_general_room_assignment:
					for i := range total_iterations {
						...
						if !is_time_slot_available && i == total_iterations-1 {
							...
							break loop_with_general_room_assignment // return IterBreakCurriculumLoop
						}
						...
						if subject.IsGymType() {
							...
							/////////////////////////////////////////////////////////////////////////////////////////////////////////
							//                                       find available general gym room
							/////////////////////////////////////////////////////////////////////////////////////////////////////////
						...
						break
					} // -------------- end of week time slot iteration loop (with general rooms) --------------
					...
					// lec to lab and lab to lec specific room and time slot iteration
					...
					for i := range total_iterations {
						...
						room_search_iteration := 0
						room_type := uint16(1) & (^uint16(class_type)) // negated first bit to make lab rooms lec, and lec rooms lab.
						...
						break
					} // -------------- end of week time slot iteration loop (with use lab for lec, and lec for lab rooms) --------------
