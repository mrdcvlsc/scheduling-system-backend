...
func IterateSectionsWeekSchedule(
	...
	fn_curriculum_block func(curriculum_idx int, curriculum *Curriculum.Curriculum) IterReturnType,
...
curriculum_loop:
	for curriculum_idx, curriculum := range curriculums {
		...
		if fn_curriculum_block != nil {
			irt_curriculum_block := fn_curriculum_block(curriculum_idx, &curriculum)
